...
:doit
if /i "%1#" == "--libs#"    echo -LD:/QtStudy/MPlayer/TagLib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -ID:/QtStudy/MPlayer/TagLib/include -ID:/QtStudy/MPlayer/TagLib/include/taglib
if /i "%1#" == "--version#" echo 2.0.1
if /i "%1#" == "--prefix#"  echo D:/QtStudy/MPlayer/TagLib
